...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="alert alert-danger text-center mt-3">
                    Por favor selecione pelo menos uma operação. As parcelas devem ser números entre 0 e 99. O número de exercícios deve variar entre 5 e 50.
                </div>
            </div>
        </div>
    @endif
    ...
    <footer class="text-center mt-5">
        <p class="text-secondary">JCarvalho &copy; <span class="text-info">2025</span></p>
    </footer>
